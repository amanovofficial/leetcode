...
// решена через арифметическую прогрессию
// Формула для нахождения суммы арифметической прогрессии: S(n) = (A1+An)*n/2
function missingNumber(nums: number[]): number {

    const n = nums.length;//в данном массиве отсутствует один элемент, на самом деле в массиве должен быть n+1 элементов с учетом отсутствующего элемента
    let sum = 0;
